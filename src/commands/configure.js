...
const templateEngines = ["handlebars", "mustache"]
...
async function configure(options) {
  ...
  const templateEngineResponse = (await askQuestion("Which templating engine would you like to use? (defaults to handlebars)\nOptions: "+templateEngines.join(", ") + "\n> ")).trim()
